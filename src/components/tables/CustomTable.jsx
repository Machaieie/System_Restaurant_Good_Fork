...
function createData(client, date, time, numberPeople, phone,email) {
    return {
        client,
        date,
        time,
...
const headCells = [
    ...
    { id: 'numberPeople', numeric: true, disablePadding: false, label: 'Número de Pessoas' },
